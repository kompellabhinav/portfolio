...
export const EXPERIENCES = [
  {
    ...
    description: [
      <>
        Engineered an in-app exam rescheduling feature within an Electron desktop application using Angular and Java Spring Boot, eliminating the need for candidates to navigate to external portals.   
      </>,
      <>
        Configured and managed infrastructure deployments across multiple environments utilizing Azure Terraform to ensure stable integration of the new feature.
      </>,
      <>
        Collaborated with cross-functional engineering teams to seamlessly integrate the end-to-end workflow, successfully reducing candidate abandonment rates and significantly lowering customer support ticket volume.   
      </>,
      <>
        Engineered an automated workspace compliance feature using Spring microservices, integrating Gemini AI to instantly analyze candidate workspace photos for restricted objects.
      </>,
      <>
        Implemented an event-driven architecture utilizing Ably Pub/Sub to orchestrate real-time messaging across multiple microservices upon AI processing completion.
      </>,
      <>
        Eliminated candidate wait times and reduced manual greeter workload by automating the verification stage, allowing compliant candidates to bypass the manual queue and instantly begin their exams.
      </>
    ],
